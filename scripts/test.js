const qs=[
['If your income increased by 30% starting next month, what would most likely happen?',['I would raise my lifestyle and allow myself things I had been putting off.','I would increase some expenses and try to keep part of the increase.','I would make a plan to divide the increase between saving, goals, and income growth.','I would direct most of the increase toward building assets or skills that could increase my future income.'],'system'],
['If your income stopped tomorrow, how long could you cover your essential expenses without borrowing?',['Less than one month.','One to three months.','Three to six months.','More than six months, and I also have another income source.'],'protection'],
['You receive an unexpected extra $1,000. What would you most likely do?',['Buy something I have wanted for a while.','Keep the money in cash in case I need it.','Split it between a current financial goal, emergency savings, or debt repayment.','First decide what would create the greatest long-term impact, such as paying expensive debt, building a buffer, or developing a skill or asset.'],'management'],
['At the end of the month, when you review your spending, which description fits you best?',['Sometimes I do not know where a large part of my money went.','I have a general idea of my spending, but I do not track it consistently.','I know my essential expenses and have clear spending limits.','I have a system that automatically allocates my income before I start spending.'],'management'],
['Which description best matches your current debt situation?',['Debt puts pressure on my monthly decisions.','I have debt, but I deal with it when I can.','I have a clear payoff plan and know what to prioritize.','My consumer debt is under control or nonexistent, and I work to keep it that way.'],'management'],
['You want to buy something that costs $1,500. What do you usually do?',['If the money is available, I buy it.','I wait a little and see if I still want it.','I compare options and make sure the purchase will not hurt my financial goals.','I already have money allocated for it and can buy it without disrupting my financial system.'],'system'],
['If you wanted to increase your income over the next year, what are you doing now?',['Waiting for a better opportunity or a raise.','Thinking about a few ideas, but I do not have a clear plan yet.','Working on a skill that could increase my value.','Following a specific plan to build a skill or new income source and giving it regular time.'],'growth'],
['Which statement best describes how you handle saving and investing?',['I save whatever is left at the end of the month.','I try to save, but the amount changes from month to month.','I set aside a fixed amount before spending.','I use automatic transfers so saving or investing happens without relying on a monthly decision.'],'system'],
['If you had an opportunity to increase your income but it required a lot of additional time, how would you think about it?',['I would take it as long as it increases my income.','I would take it temporarily if I needed the money.','I would compare the extra income with the cost to my time and life.','I would prefer building a skill or asset that can increase my income without relying entirely on more working hours.'],'growth'],
['You have a stable financial foundation and some money you will not need soon. What do you do?',['Keep it in cash because I do not want to take risks.','Look for an opportunity that seems profitable and decide based on what I find.','Learn about risks, goals, and suitable options first.','Follow a long-term strategy rather than chasing the latest opportunity.'],'growth'],
